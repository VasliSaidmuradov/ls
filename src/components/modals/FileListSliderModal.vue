<template>
  <q-dialog :value="isFileListSliderModalOpen" @hide="closeModal">
    <div class="modal">
      ...
      <img
        :src="fileList[currentPage - 1] && fileList[currentPage - 1].file_link"
        class="modal__file-img"
        alt=""
        v-if="!countIsPdf"
      />
      ...
      <div class="modal__pdf-block" v-else>
        ...
        <q-btn class="modal__pdf-block-btn">
          ...
          <a
            :href="fileList[currentPage - 1] && fileList[currentPage - 1].file_link"
            target="_blank"
            class="modal__pdf-block-btn-text"
          >
    ...
    >
      <template v-slot:btn1>
        ...
        >
          <template v-slot:icon>
            <icon name="delete-icon" class="modal__delete-file-btn-icon" />
          </template>
        </main-btn>
      </template>
    </dialog-modal>
