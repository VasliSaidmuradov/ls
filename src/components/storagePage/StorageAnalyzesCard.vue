    ...
    <div class="analyzes-card__right">
      <div class="analyzes-card__date">
        ...
        <div class="analyzes-card__date-value">
          ...
          <div class="edit">
            <InputDate :value="dataClone.date" :propRules="rules" ref="date"
      ...
      <div class="analyzes-card__actions">
        <button class="analyzes-card__actions-btn analyzes-card__actions-btn--edit"
                @click="isEditMode ? saveChanges() : editAnalyzes()">
...
<script lang="ts">
  ...
  export default class StorageAnalyzesCard extends Mixins(AnalyzesMixin, BaseFormMixins) {
